      ...
      >
        {!expanded && (
          <button
            ...
            className="absolute inset-0 flex h-12 w-12 items-center justify-center rounded-full border border-zinc-700 bg-zinc-900 text-zinc-300 shadow-xl transition-all hover:border-purple-500/50 hover:text-white hover:shadow-[0_0_15px_rgba(168,85,247,0.3)]"
          >
        ...
        {expanded && (
          <motion.div 
            ...
            className="w-full bg-zinc-900/95 backdrop-blur-xl border border-zinc-700/50 rounded-2xl shadow-2xl p-4 flex flex-col gap-4"
          >
            ...
            <div className="p-3 bg-zinc-950/50 rounded-xl border border-zinc-800 relative overflow-hidden">
