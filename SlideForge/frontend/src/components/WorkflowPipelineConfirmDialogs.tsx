  ...
  return (
    ...
    >
      <div
        ...
        className="sf-dialog-shell sf-dialog-shell-ring w-full max-w-sm rounded-xl border p-4 sm:p-5"
        onMouseDown={(e) => e.stopPropagation()}
      >
        <div className="flex items-start justify-between gap-3">
          <h2
            id="cancel-pipeline-title"
            className="text-sm font-semibold sf-text-primary sm:text-base"
          >
            {copy.title}
          </h2>
          <button
            ...
            disabled={busy}
            onClick={onClose}
            className="rounded-md p-1 sf-text-muted transition-colors hover:bg-[var(--sf-chip-neutral-hover-bg)] hover:text-[var(--sf-text-primary)] disabled:opacity-40"
            aria-label="关闭"
          >
            <X className="h-4 w-4" />
          </button>
        </div>
        <p className="mt-2 text-xs leading-relaxed sf-text-secondary sm:text-sm">
          {copy.description}
        </p>
        <div className="mt-4 flex flex-col gap-2 sm:flex-row sm:flex-wrap sm:justify-end">
          <button
            ...
            disabled={busy}
            onClick={onClose}
            className="order-2 rounded-lg border border-[var(--sf-border-base)] px-3 py-2 text-xs font-medium sf-text-secondary transition-colors hover:bg-[var(--sf-chip-neutral-hover-bg)] hover:text-[var(--sf-text-primary)] sm:px-4 sm:text-sm"
          >
            关闭
          </button>
          <button
