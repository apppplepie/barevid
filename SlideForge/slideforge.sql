/*
 ...
 Source Schema         : slideforge

 Target Server Type    : MySQL
 Target Server Version : 80032
 File Encoding         : 65001

 Date: 28/03/2026 10:47:41
*/
...
CREATE TABLE `project_styles`  (
  ...
  `style_base_json` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `style_prompt_text` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
...
CREATE TABLE `workflow_export_runs`  (
  ...
  `output_file_url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
...
-- ----------------------------
-- Table structure for video_export_jobs（远程 worker 视频导出队列）
-- ----------------------------
