...
export const TTS_VOICE_PRESETS_FALLBACK: { value: string; label: string }[] = [
  ...
  { value: 'saturn_zh_female_cancan_tob', label: '可爱女生（角色扮演 · 2.0）' },
  { value: 'saturn_zh_female_keainvsheng_tob', label: '调皮公主（角色扮演 · 2.0）' },
  { value: 'saturn_zh_female_tiaopigongzhu_tob', label: '爽朗少年（角色扮演 · 2.0）' },
  { value: 'saturn_zh_male_shuanglangshaonian_tob', label: '天才同桌（角色扮演 · 2.0）' },
  { value: 'saturn_zh_male_tiancaitongzhuo_tob', label: '小何（角色扮演 · 2.0）' },
