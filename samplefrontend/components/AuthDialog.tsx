...
export function AuthDialog({ open, onClose, onSuccess }: AuthDialogProps) {
  ...
  return createPortal(
    <div
      className="sf-theme sf-modal-backdrop-medium fixed inset-0 z-[200] flex items-center justify-center p-4 backdrop-blur-sm"
      role="dialog"
      aria-modal="true"
        ...
        <form onSubmit={submit} className="flex flex-col gap-4 p-4">
          ...
          <div className="space-y-1.5">
            ...
            <input
              ...
              className="w-full rounded-lg border border-zinc-800 sf-border-base bg-zinc-900 sf-bg-card px-3 py-2 text-sm text-zinc-100 sf-text-primary focus:border-purple-500/50 focus:outline-none"
            />
          </div>
          <div className="space-y-1.5">
