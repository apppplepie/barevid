...
import { DeckAssistantModule, type DeckAssistantModuleProps } from './AIAssistantPanel';
import {
  ...
  return (
    <AnimatePresence>
      {isOpen && (
        ...
        >
          <div
            className="absolute left-0 top-0 bottom-0 w-1 cursor-col-resize hover:bg-zinc-500/50 transition-colors z-50"
          ...
          <div className="flex min-w-0 shrink-0 items-center justify-between gap-2 border-b sf-border-base sf-bg-card p-4">
            <div className="flex min-w-0 flex-1 items-center gap-2">
              ...
              <div className="min-w-0 flex-1">
                <h3 className="truncate text-sm font-medium text-zinc-100 sf-text-primary">
            ...
            <button
              type="button"
              onClick={onClose}
              className="shrink-0 rounded-md p-1.5 text-zinc-500 sf-text-muted transition-colors hover:bg-zinc-800/70 hover:text-zinc-100 sf-text-primary"
              aria-label="关闭右侧面板"
            >
              <X className="h-4 w-4" />
            </button>
