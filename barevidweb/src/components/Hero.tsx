...
export function Hero() {
  ...
  return (
    <section id="hero" className="h-screen w-full snap-start snap-always pt-16 px-6 flex items-center relative overflow-hidden">
      <div className="max-w-7xl mx-auto w-full grid lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-4 mt-4">
            <button className="flex items-center gap-2 px-6 py-3 bg-white text-black font-bold uppercase tracking-wider hover:bg-white/90 transition-colors rounded-sm shadow-[0_0_20px_rgba(255,255,255,0.15)]">
        ...
        <motion.div
          ...
          className="relative"
        >
          <div className="absolute -inset-1 bg-gradient-to-r from-primary to-secondary blur-xl opacity-20 rounded-lg" />
          <TerminalSimulator />
        </motion.div>
      </div>
    </section>
