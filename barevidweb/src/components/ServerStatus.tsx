...
const XIAO_HONG_SHU_URL = 'https://xhslink.com/m/7hKGwAtfMbf';
          ...
          <CyberCard delay={0.1} themeColor="secondary">
            ...
            <div className="grid grid-cols-2 gap-3">
              <a href={XIAN_YU_SHOP_URL} target="_blank" rel="noreferrer" className="flex items-center justify-center gap-2 w-full py-3 bg-secondary/10 border border-secondary/50 text-secondary hover:bg-secondary hover:text-black transition-all font-bold uppercase tracking-widest text-sm">
                {t('status.visitXianyu')} <ExternalLink size={14} />
              </a>
              <a href={XIAO_HONG_SHU_URL} target="_blank" rel="noreferrer" className="flex items-center justify-center gap-2 w-full py-3 bg-secondary/10 border border-secondary/50 text-secondary hover:bg-secondary hover:text-black transition-all font-bold uppercase tracking-widest text-sm">
                {t('status.visitXiaohongshu')} <ExternalLink size={14} />
              </a>
            </div>
          </CyberCard>
